...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("BTPConnectionListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheBTPConnectionListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheBTPConnectionListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheBTPConnectionListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheBTPConnectionListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheBTPConnectionListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheBTPConnectionListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheBTPConnectionListGenerated.onTable(defaultTableId).iPressRow(0);
